...
export function NoteEditor({ initialContent, docKey, onSave, onImagePaste }: NoteEditorProps) {
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'min-h-[400px] w-full text-white placeholder-white/40 focus:outline-none overflow-y-auto prose prose-invert max-w-none',
            },
    ...
    return (
        <div className="relative">
            ...
            <div className="flex items-center justify-between mb-3">
                <h2 className="heading-2 text-white" style={{ fontFamily: "var(--font-space-grotesk, sans-serif)" }}>
                    Notes
                </h2>
                <AnimatePresence>
                    {saving && (
