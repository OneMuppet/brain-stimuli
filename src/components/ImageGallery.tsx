            ...
            >
              ...
              {onDelete && (
                <button
                  ...
                  className="absolute top-1 right-1 opacity-0 group-hover:opacity-100 transition-opacity bg-black/70 border border-red-400/30 hover:border-red-400/50 text-red-400/70 hover:text-red-400/90 rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold backdrop-blur-sm"
                  style={{
                    boxShadow: "inset 0 0 8px rgba(239, 68, 68, 0.15)",
                  }}
                >
                  ×
                </button>
